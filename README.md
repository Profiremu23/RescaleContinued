...
To install, you need to install the required mods. Select ONLY one of scale configs, for example to play 2.5x scaled system, you need the Rescale 2.5x folder.
